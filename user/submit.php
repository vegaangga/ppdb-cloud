...
//define
define('ORACLE_ACCESS_KEY','https://objectstorage.ap-sydney-1.oraclecloud.com/p/2qRypg64_4IXyif3suv5gASN3YxSZJ9NTrtjdf1pac_tAVedwuwPwJxVaUOWg96H/n/sdotrlccqowx/b/uts-ve/o/');
define('ORACLE_SECRET_KEY','IQDuQyYITF6aygo4I9yIKSX7FdCyxyHMgrUjN+DHJds=');
define('ORACLE_REGION', 'ap-sydney-1');
define ('ORACLE_ENDPOINT','https://objectstorage.ap-sydney-1.oraclecloud.com/p/2qRypg64_4IXyif3suv5gASN3YxSZJ9NTrtjdf1pac_tAVedwuwPwJxVaUOWg96H/n/sdotrlccqowx/b/uts-ve/o/');
        ...
        if($gambar_produk != ""){
          ...
          if(in_array($ekstensi,$ekstensi_diperbolehkan)=== true){
            ...
            $result = $S3->putObject([
              ...
              'SourceFile' => $tmp_file, $tmp_file2, $tmp_file3,
